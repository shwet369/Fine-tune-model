...
Goal: Train a Convolutional Neural Network (CNN) model to predict a person’s age using the UTKFace dataset. We will fine-tune a pre-trained model like MobileNetV2 or ResNet50 to 
